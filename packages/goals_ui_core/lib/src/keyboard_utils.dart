...
import 'package:flutter/widgets.dart'
    show Intent, ShortcutActivator, SingleActivator;
...
final SHORTCUTS = <ShortcutActivator, Intent>{
  ...
  SingleActivator(LogicalKeyboardKey.keyP, control: true):
      const CommandIntent(),
  SingleActivator(LogicalKeyboardKey.keyF, control: true): const SearchIntent(),
...
final MAC_SHORTCUTS = <ShortcutActivator, Intent>{
  SingleActivator(LogicalKeyboardKey.keyK, meta: true): const CommandIntent(),
  SingleActivator(LogicalKeyboardKey.keyP, meta: true): const CommandIntent(),
  SingleActivator(LogicalKeyboardKey.keyZ, meta: true): const UndoIntent(),
  SingleActivator(LogicalKeyboardKey.keyF, meta: true): const SearchIntent(),
